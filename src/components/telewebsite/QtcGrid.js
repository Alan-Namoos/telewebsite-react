    ...
    return (
        <>
            <table id="mouse" className="center" cellSpacing="0">
              ...
              <hr />
              <div id="results" >
              <span id="hr" style={{'fontSize': '16px'}} className="badge badge-dark">{''}</span>
                <span  id="qt" style={{"fontSize": "16px"}} className="badge badge-dark">{''}</span>
                <span id="qtc" style={{"fontSize": "16px"}} className="badge">{''}</span>
              </div> 
